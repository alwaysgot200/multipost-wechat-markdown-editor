...
NetlifyConfig : build.command = "pnpm run build : h5-netlify"
NetlifyConfig : build.publish = "dist"
NetlifyConfig : redirects.from = "/*"
NetlifyConfig : redirects.to = "/index.html"
NetlifyConfig : redirects.status = 200
```

...
graph TD
    ...
    style A fill:#e1f5ff,stroke:#0284c7,stroke-width:2px
...
graph TD
    ...
    B -->|"Chrome"| C["side_panel.default_path<br/>= sidepanel.html"]
    B -->|"Firefox"| D["sidebar_action.default_panel<br/>= sidepanel.html"]
    ...
    style E fill:#e1f5ff,stroke:#0284c7,stroke-width:2px
...
graph TD
    ...
    C --> D["添加alias"]
    D --> E["/src/main.ts<br/>→ ./src/main.ts"]
    D --> F["/src/sidepanel.ts<br/>→ ./src/sidepanel.ts"]
...
graph TD
    ...
    B --> C["PLATFORMS<br/>linux/amd64, linux/arm64"]
